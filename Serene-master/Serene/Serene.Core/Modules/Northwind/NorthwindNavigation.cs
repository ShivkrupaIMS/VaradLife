...
using MyPages = Serene.Northwind.Pages;
...
[assembly: NavigationLink(int.MaxValue, "Northwind/Products New", typeof(MyPages.ProductsNewController), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Northwind/Movie", typeof(MyPages.MovieController), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Northwind/Person", typeof(MyPages.PersonController), icon: null)]
