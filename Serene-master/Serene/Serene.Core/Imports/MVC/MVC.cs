...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Masters
        {
            ...
            {
                public const string CityIndex = "~/Modules/Masters/City/CityIndex.cshtml";
            }

            public static class Company
            {
                public const string CompanyIndex = "~/Modules/Masters/Company/CompanyIndex.cshtml";
            }

            public static class CompanyType
            {
                public const string CompanyTypeIndex = "~/Modules/Masters/CompanyType/CompanyTypeIndex.cshtml";
            }

            public static class Country
            {
                public const string CountryIndex = "~/Modules/Masters/Country/CountryIndex.cshtml";
            }

            public static class Customers
            {
                public const string CustomersIndex = "~/Modules/Masters/Customers/CustomersIndex.cshtml";
            }

            public static class CustomerType
            {
                public const string CustomerTypeIndex = "~/Modules/Masters/CustomerType/CustomerTypeIndex.cshtml";
            }

            public static class GstRegistrationType
            {
                public const string GstRegistrationTypeIndex = "~/Modules/Masters/GstRegistrationType/GstRegistrationTypeIndex.cshtml";
            }

            public static class Hsnsac
            {
                public const string HsnsacIndex = "~/Modules/Masters/Hsnsac/HsnsacIndex.cshtml";
            }

            public static class InvoiceStatus
            {
                public const string InvoiceStatusIndex = "~/Modules/Masters/InvoiceStatus/InvoiceStatusIndex.cshtml";
            }

            public static class InvoiceTerm
            {
                public const string InvoiceTermIndex = "~/Modules/Masters/InvoiceTerm/InvoiceTermIndex.cshtml";
            }

            public static class LicenseType
            {
                public const string LicenseTypeIndex = "~/Modules/Masters/LicenseType/LicenseTypeIndex.cshtml";
            }

            public static class Manufacturer
            {
                public const string ManufacturerIndex = "~/Modules/Masters/Manufacturer/ManufacturerIndex.cshtml";
            }

            public static class Product
            {
                public const string ProductIndex = "~/Modules/Masters/Product/ProductIndex.cshtml";
            }

            public static class ProductType
            {
                public const string ProductTypeIndex = "~/Modules/Masters/ProductType/ProductTypeIndex.cshtml";
            }

            public static class ProductUnit
            {
                public const string ProductUnitIndex = "~/Modules/Masters/ProductUnit/ProductUnitIndex.cshtml";
            }

            public static class PurchaseInvoice
            {
                public const string PurchaseInvoiceIndex = "~/Modules/Masters/PurchaseInvoice/PurchaseInvoiceIndex.cshtml";
            }

            public static class PurchaseInvoiceDetails
            {
                public const string PurchaseInvoiceDetailsIndex = "~/Modules/Masters/PurchaseInvoiceDetails/PurchaseInvoiceDetailsIndex.cshtml";
            }

            public static class State
            {
                public const string StateIndex = "~/Modules/Masters/State/StateIndex.cshtml";
            }

            public static class Suppliers
            {
                public const string SuppliersIndex = "~/Modules/Masters/Suppliers/SuppliersIndex.cshtml";
            }

            public static class SupplierType
            {
                public const string SupplierTypeIndex = "~/Modules/Masters/SupplierType/SupplierTypeIndex.cshtml";
            }
        ...
        public static class Northwind
        {
            ...
            {
                public const string MovieIndex = "~/Modules/Northwind/Movie/MovieIndex.cshtml";
            }
            ...
            {
                public const string PersonIndex = "~/Modules/Northwind/Person/PersonIndex.cshtml";
            }
            ...
            public static class ProductsNew
            {
                public const string ProductsNewIndex = "~/Modules/Northwind/ProductsNew/ProductsNewIndex.cshtml";
            }
