namespace Serene.Northwind {
    export namespace PersonService {
        export const baseUrl = 'Northwind/Person';
        ...
        export declare const enum Methods {
            Create = "Northwind/Person/Create",
            Update = "Northwind/Person/Update",
            Delete = "Northwind/Person/Delete",
            Retrieve = "Northwind/Person/Retrieve",
            List = "Northwind/Person/List"
        }
